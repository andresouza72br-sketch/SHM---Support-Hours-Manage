...
$VAULT_ROOT = "C:\Users\andre\orca\backups-locais\projeto-SHM"
$ITEMS_TO_MANAGE = @(
    "_reversa_forward",
    "_reversa_refactor",
    "_reversa_bugs",
...
if (-not $mainRepo -or -not (Test-Path $mainRepo)) {
    if (Test-Path "C:\Users\andre\mkt-dnb\dev\Antigravity\projeto-SHM") {
        $mainRepo = "C:\Users\andre\mkt-dnb\dev\Antigravity\projeto-SHM"
    } else {
        $mainRepo = $currentDir
    }
}
