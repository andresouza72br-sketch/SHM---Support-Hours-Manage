...
CONFIGURACOES_PADRAO = [
    ...
    # --- SCHEDULE / AGENDAMENTOS ---
    {
        ...
        "categoria": CategoriaNotificacao.SCHEDULE,
        "nome": "Nova Reunião de Suporte Agendada",
        "descricao": "Disparado quando uma nova reunião é agendada para um pedido, ciclo ou cliente.",
        "ativo_email": True,
        "ativo_in_app": True,
        "notificar_empresa_admin": True,
        "notificar_empresa_tecnico": True,
    ...
    },
    {
        ...
        "categoria": CategoriaNotificacao.SCHEDULE,
        "nome": "Remarcação de Reunião de Suporte",
        "descricao": "Disparado quando a data ou horário de um agendamento é alterado no SHM.",
        "ativo_email": True,
        "ativo_in_app": True,
        "notificar_empresa_admin": True,
        "notificar_empresa_tecnico": True,
    ...
    {
        "codigo": "SCHEDULE_LEMBRETE_24H",
        "categoria": CategoriaNotificacao.SCHEDULE,
        "nome": "Lembrete de Reunião (24 Horas Antes)",
        "descricao": "Disparado 24 horas antes do início programado de um compromisso de suporte.",
        "ativo_email": True,
        "ativo_in_app": True,
        "notificar_empresa_admin": True,
        "notificar_empresa_tecnico": True,
    ...
    {
        "codigo": "SCHEDULE_LEMBRETE_30M",
        "categoria": CategoriaNotificacao.SCHEDULE,
        "nome": "Lembrete de Reunião (30 Minutos Antes)",
        "descricao": "Disparado 30 minutos antes do início do compromisso para alinhamento dos participantes.",
        "ativo_email": True,
        "ativo_in_app": True,
        "notificar_empresa_admin": True,
        "notificar_empresa_tecnico": True,
    ...
    {
        "codigo": "SCHEDULE_LEMBRETE_15M",
        "categoria": CategoriaNotificacao.SCHEDULE,
        "nome": "Aviso Imediato de Reunião (15 Minutos Antes - Google Meet)",
        "descricao": "Disparado 15 minutos antes da reunião com botão de acesso direto à sala do Google Meet.",
        "ativo_email": False,
        "ativo_in_app": True,
        "notificar_empresa_admin": True,
        "notificar_empresa_tecnico": True,
    ...
    },
    {
        ...
        "categoria": CategoriaNotificacao.SCHEDULE,
        "nome": "Cancelamento de Reunião de Suporte",
        "descricao": "Disparado quando um agendamento é cancelado no SHM.",
        "ativo_email": True,
        "ativo_in_app": True,
        "notificar_empresa_admin": True,
        "notificar_empresa_tecnico": True,
