  ...
  return (
    <AppLayout showSidebar={false}>
      {() => {
        ...
        if (isLoading) {
          return <div className="p-12 text-center text-slate-400 font-medium">Carregando detalhes do pedido...</div>
        }

        if (!pedido) {
          return <div className="p-12 text-center text-rose-500 font-bold">Pedido não encontrado.</div>
        }
