...
export function ExecucaoCicloPage() {
  ...
  if (isLoading) return <div className="p-12 text-center text-slate-400">Carregando ciclo...</div>
  if (!ciclo) return <div className="p-12 text-center text-rose-500 font-bold">Ciclo não encontrado.</div>
